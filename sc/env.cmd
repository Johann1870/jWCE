...
::TITLES AND COLORS
	...
	::CHECKS ADMIN STATUS
	FSUTIL DIRTY QUERY %SYSTEMDRIVE% > nul 2> nul && (TITLE ADMIN %TITLE4%&SET FCOLOR=%FCOLOR:~0,1%&SET BCOLOR=%BCOLOR:~0,1%&SET PROMPTSYMBOL=[91;40m#) || (SET BCOLOR=%BCOLOR:~1,1%&SET FCOLOR=%FCOLOR:~1,1%&TITLE NONADMIN %TITLE4%&SET PROMPTSYMBOL=[92;40m$$)	
...
PROMPT [94;40m#$S[96;40m%USERNAME%$S[97;40m@$S[92;40m%COMPUTERNAME%$S[97;40min$S[93;40m$P$S[97;40m[$T]$_%PROMPTSYMBOL%[97;40m
